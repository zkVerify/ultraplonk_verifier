...
The UltraPlonk zk-SNARK verifier is a Rust-based implementation of the Noir's Ultraplonk Solidity verifier, optimized to be use contextually with [zkVerify](https://github.com/zkVerify/zkVerify). 
